...
urlpatterns = [
    ...
    path("getcourse_bonus/<str:gc_id>/", views.index_no_user, name="index_no_user"),
    path("order_from_gc/", views.order_from_gc),
    path("profile/", views.profile, name="profile"),
    path(
        "profile/my_test_results/",
        views.profile_test_results,
        name="profile_test_results",
    ),
    path("profile/my_group/", views.profile_my_group, name="profile_my_group"),
    path(
        "profile/my_group/choose/",
        views.profile_my_group_choose,
        name="profile_my_group_choose",
    ),
    ...
    path(
        "create_order_from_gc/", views.create_order_from_gc, name="create_order_from_gc"
    ),
